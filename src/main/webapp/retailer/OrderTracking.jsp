...
try (Connection conn = PostgresConnection.getConnection()) {
	...
	//Get Data 
	String sql = "SELECT t.transport_name, dt.status, dr.product_name, dr.quantity, dr.price, dr.buyer_name, dr.buyer_contact, dr.delivery_address, dr.delivery_expected_date FROM transport.delivery_tracking dt JOIN transport.shipment s ON dt.shipment_id = s.shipment_id JOIN transport.delivery_request dr ON s.delivery_request_id = dr.delivery_request_id JOIN transport.transport t ON dt.transport_id = t.transport_id WHERE dt.delivery_id = ? ";
