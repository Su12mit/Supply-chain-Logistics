...
try (Connection conn = PostgresConnection.getConnection()) {
		...
		String sql = "SELECT rtp.bank_name, rtp.account_no, rtp.ifsc_code  FROM retailer.retailer rtp JOIN retailer.invoice iv ON iv.retailer_id = rtp.retailer_id WHERE iv.order_id = ? ";
