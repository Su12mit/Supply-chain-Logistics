...
try (Connection conn = PostgresConnection.getConnection()) {
	...
	String sql = "SELECT wh.shop_name, wh.address, wh.wholeseller_contact, wlg.email, c.customer_name, c.customer_address, rpo.order_request_id, rpo.payment_status, rpo.transaction_id, rpo.mode_of_payment,  rpo.payment_amount, rpo.tr_date_time, wor.product_name, wor.quantity, wor.price FROM wholeseller.retailer_payments rpo JOIN wholeseller.wholeseller wh ON wh.wholeseller_id = rpo.wholeseller_id JOIN wholeseller.order_request wor ON rpo.order_request_id = wor.order_request_id JOIN wholeseller.login wlg ON wlg.login_id = wh.wholeseller_id JOIN wholeseller.customer c ON c.customer_id = wor.customer_id WHERE rpo.pay_slip_id = ?";
