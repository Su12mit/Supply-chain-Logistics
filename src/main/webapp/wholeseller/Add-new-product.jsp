...
<%
    ...
    if (isReorder) {
            ...
            String sql = "SELECT s.product_name, s.quantity, s.price, s.stock_date, s.brand_name, s.weight, s.warrenty, sc.category_name FROM wholeseller.stock s JOIN wholeseller.stock_cat sc ON s.stock_cat_id = sc.stock_cat_id WHERE s.stock_id = ?";
...
<body>
  <div class="container">
   ...
   <form id="productForm" action="/Supply-chain-and-Logistic/AddnewProductServlet" method="post" enctype="multipart/form-data">
